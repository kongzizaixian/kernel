...
static int hclge_set_vlan_tx_offload_cfg(struct hclge_vport *vport)
{
	...
	hnae3_set_bit(req->vport_vlan_cfg, HCLGE_ACCEPT_TAG_B,
		      vcfg->accept_tag ? 1 : 0);
	hnae3_set_bit(req->vport_vlan_cfg, HCLGE_ACCEPT_UNTAG_B,
				    ...
				    u8 locate_led_status)
{
	...
	hnae3_set_field(req->port_speed_led_config,
			HCLGE_LED_PORT_SPEED_STATE_M,
			HCLGE_LED_PORT_SPEED_STATE_S, speed_led_status);
	hnae3_set_field(req->link_led_config, HCLGE_LED_ACTIVITY_STATE_M,
			HCLGE_LED_ACTIVITY_STATE_S, act_led_status);
	hnae3_set_field(req->activity_led_config, HCLGE_LED_LINK_STATE_M,
